...
var AvatarUploader = /** @class */ (function (_super) {
    __extends(AvatarUploader, _super);
    function AvatarUploader(props) {
        var _this = _super.call(this, props) || this;
        _this.mRefInputFile = reactExports.createRef();
        _this.mRefZoom = reactExports.createRef();
        _this.mRefRotDiv = reactExports.createRef();
        _this.mRefPanelButtons = reactExports.createRef();
        _this.mRefCanvas = reactExports.createRef();
        _this.mRefLink1 = reactExports.createRef();
        _this.mRefLink2 = reactExports.createRef();
        _this.coord = { x: 0, y: 0 };
        _this.coordE = { x: 0, y: 0 };
        _this.coordS = { x: 0, y: 0 };
        _this.base_image = undefined;
        _this.isStart = false;
        _this.mFile = undefined;
        _this.imageSize = {
            width: _this.props.canvasSize,
            height: _this.props.canvasSize,
            scaleW: _this.props.canvasSize,
        };
        _this.mContext = null;
        _this.onFileChange = _this.onFileChange.bind(_this);
        _this.previewF = _this.previewF.bind(_this);
        _this.formUpload = _this.formUpload.bind(_this);
    ...
    AvatarUploader.prototype.componentDidMount = function () {
        this.mRefCanvas.current.width = this.props.canvasSize;
        this.mRefCanvas.current.height = this.props.canvasSize;
        this.mRefRotDiv.current.style.width = "".concat(this.props.canvasSize, "px");
    ...
    AvatarUploader.prototype.wheel = function (e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        if (!this.mFile)
            return;
        e = e || window.event;
        var v = parseInt(this.mRefZoom.current.value);
        var delta = e.deltaY || e.detail || e.deltaY;
        if (delta > 0 && v < 99) {
    ...
    AvatarUploader.prototype.start = function (e) {
        this.mRefCanvas.current.addEventListener("mousemove", this.draw);
        this.reposition(e);
        this.isStart = true;
    };
    AvatarUploader.prototype.stop = function () {
        if (!this.mFile)
            return;
        if (this.isStart) {
    ...
    AvatarUploader.prototype.reposition = function (e) {
        this.coord.x = e.offsetX;
        this.coord.y = e.offsetY;
    };
    AvatarUploader.prototype.draw = function (e) {
        if (!this.mFile)
            return;
    ...
    AvatarUploader.prototype.onFileChange = function (event) {
        var _this = this;
        ...
        var imgSrc = window.URL.createObjectURL(this.mFile);
        this.base_image = new Image();
        this.base_image.src = imgSrc;
        this.base_image.onload = function () {
            var _a, _b;
            if ((_a = _this.base_image) === null || _a === void 0 ? void 0 : _a.width) {
                _this.imageSize.width = _this.base_image.width;
            }
            if ((_b = _this.base_image) === null || _b === void 0 ? void 0 : _b.height) {
                _this.imageSize.height = _this.base_image.height;
            }
            _this.drawImageE();
        };
        this.mRefPanelButtons.current.style.visibility = "visible";
    };
    AvatarUploader.prototype.drawImageE = function () {
    ...
    AvatarUploader.prototype.zoomImage = function (v) {
        if (!this.mFile)
            return;
        this.imageSize.scaleW = v;
        this.drawImageE();
    };
    AvatarUploader.prototype.previewF = function () {
        if (this.props.preview) {
            this.props.preview(this.mContext.canvas.toDataURL());
        }
    };
    AvatarUploader.prototype.getCanvasFormData = function () {
        return this.mContext.canvas.toDataURL();
    };
    AvatarUploader.prototype.getWidth = function () {
        return Math.round(this.imageSize.width * this.imageSize.scaleW / 100);
    };
    AvatarUploader.prototype.getHeight = function () {
        return Math.round(this.imageSize.height * this.imageSize.scaleW / 100);
    };
    AvatarUploader.prototype.formUpload = function () {
        var _this = this;
        try {
            ...
            xhr_1.open("POST", this.props.url);
            ...
            if (this.props.headerKeyValue) {
                for (var key in this.props.headerKeyValue) {
                    xhr_1.setRequestHeader(key, this.props.headerKeyValue[key]);
                }
            }
            formData.append("avatar", this.mContext.canvas.toDataURL());
            xhr_1.onreadystatechange = function (d) {
                if (xhr_1.readyState === 4) {
                    if (xhr_1.status === 200) {
                        if (_this.props.done) {
                            // @ts-ignore
                            _this.props.done(d.target.response);
                            _this.clear();
                        }
                    }
                    else {
                        var innerText = "Error: ".concat(xhr_1.status, " ").concat(xhr_1.statusText, " ").concat(xhr_1.responseText, " ");
                        if (_this.props.serverError) {
                            _this.props.serverError(innerText);
                        }
                    }
                }
            };
    ...
    AvatarUploader.prototype.clear = function () {
        this.coord.x = 0;
        this.coord.y = 0;
        this.coordE.x = 0;
        this.coordE.y = 0;
